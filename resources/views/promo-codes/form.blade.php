<div class="grid grid-cols-1 gap-5 sm:grid-cols-2">
    <div>
        <label class="mb-2 block text-sm font-medium text-[#F6F0E8]">Code</label>
    ...
    <div>
        <label class="mb-2 block text-sm font-medium text-[#F6F0E8]">Name</label>
    ...
    <div>
        <label class="mb-2 block text-sm font-medium text-[#F6F0E8]">Discount Type</label>
    ...
    <div>
        <label class="mb-2 block text-sm font-medium text-[#F6F0E8]">Discount Value</label>
    ...
    <div>
        <label class="mb-2 block text-sm font-medium text-[#F6F0E8]">Start Date</label>
    ...
    <div>
        <label class="mb-2 block text-sm font-medium text-[#F6F0E8]">Expiry Date</label>
    ...
    <div>
        <label class="mb-2 block text-sm font-medium text-[#F6F0E8]">Usage Limit</label>
    ...
    <label class="flex items-center gap-3 self-end rounded-xl border border-[#C7AD8A]/25 bg-black/20 px-4 py-3">
        <input type="checkbox" name="is_active" value="1" class="rounded border-[#8B765B] text-[#C7AD8A] focus:ring-[#C7AD8A]" {{ old('is_active', $promoCode?->is_active ?? true) ? 'checked' : '' }}>
        <span class="text-sm font-medium text-[#F6F0E8]">Active</span>
    </label>
</div>
